...
- **NPC หันหน้ามองผู้เล่น** ที่เข้ามาใกล้ในระยะที่กำหนด (default 3 บล็อก)
...
จากนั้นผู้เล่นคนไหนคลิก NPC ก็จะเห็น NPC เล่นท่า greet พร้อมได้ขนมปัง 5 ก้อนและข้อความ
...
look_at_range = 3.0          # ระยะ (บล็อก) ที่ NPC หันหน้ามองผู้เล่น (0 = ปิด)
...
- **หันหน้ามองผู้เล่น:** ใน freeze_tick เดียวกัน สแกนผู้เล่นออนไลน์ทุกคน หา NPC
  ที่ใกล้ที่สุดในระยะ `look_at_range` แล้วคำนวณ yaw/pitch หมุน NPC ไปหา
...
3. เดินเข้าใกล้ NPC ในระยะ 3 บล็อก → NPC หันหน้ามองเรา, เดินออกไป → หันกลับทิศเดิม
...
12. `/npc remove 1` → NPC หายและไม่กลับมาอีก
